      ...
      <div className="col">
        <div className="container-sm w-75 mt-4 d-flex justify-content-between  align-items-center ">
          <div className="row ">
            ...
            <div className="col-lg-4">
              <div className="cities d-flex justify-content-between">
                <p>Ahmedabad Restaurants</p>
                <i>›</i>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="cities d-flex justify-content-between">
                <p>Ajmer Restaurants</p>
                <i>›</i>
                {/* <span>›</span> */}
              </div>
            </div>
            <div className="  mt-4 col-lg-4">
              <div className="cities d-flex justify-content-between">
                <p>Alappuzha Restaurants</p>
                <i>›</i>
              </div>
            </div>
            <div className=" mt-4 col-lg-4">
              <div className="cities d-flex justify-content-between">
                <p>Allahabad Restaurants</p>
                <i>›</i>
              </div>
            </div>
            <div className="  mt-4 col-lg-4">
              <div className="cities d-flex justify-content-between mX-20">
                <p>Amravati Restaurants</p>
                <i>›</i>
                {/* <span>›</span> */}
              </div>
            </div>
            <div className=" mt-4 col-lg-4">
              <div className="cities d-flex justify-content-between">
                <p>Amritsar Restaurants</p>
                <i>›</i>
              </div>
            </div>
            <div className=" mt-4 col-lg-4">
              <div className="cities d-flex justify-content-between">
                <p>Aurangabad Restaurants</p>
                <i>›</i>
              </div>
            </div>
            <div className="  mt-4 col-lg-4">
              <div className="cities d-flex justify-content-between">
                <p>Bengaluru Restaurants</p>
                <i>›</i>
                {/* <span>›</span> */}
              </div>
            </div>
            <div className="  mt-4 col-lg-4">
              <div className="cities d-flex justify-content-between">
                <p>Bhopal Restaurants</p>
                <i>›</i>
              </div>
            </div>
            <div className="  mt-4 col-lg-4">
              <div className="cities d-flex justify-content-between">
                <p>Bhubaneswar Restaurants</p>
                <i>›</i>
              </div>
            </div>
            <div className="  mt-4 col-lg-4">
              <div className="cities d-flex justify-content-between">
                <p>Indore Restaurants </p>
                <i>›</i>
                {/* <span>›</span> */}
              </div>
            </div>
            ...
            <div className="  mt-4 col-lg-4">
              <div className="cities d-flex justify-content-between m-20">
                <p>Amravati Restaurants</p>
                <i>›</i>
                {/* <span>›</span> */}
              </div>
